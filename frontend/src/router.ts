...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        meta: { requiresAuth: true, requiresCapability: ['dm.message', 'guild-any'] satisfies RouteCapability[] }
    },
    {
        path: '/admin/guilds',
        name: 'guilds',
        component: () => import('./views/admin/guilds/GuildsPage.vue'),
        meta: { requiresAuth: true, requiresCapability: ['guild-any'] satisfies RouteCapability[] }
    },
    {
        path: '/admin/users',
        name: 'admin-users',
